      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2">
        ...
        <div className="flex gap-3">
          <button 
            ...
            className="px-4 py-2 text-sm font-medium text-white bg-violet-600 hover:bg-violet-700 rounded-lg transition-colors shadow-sm shadow-violet-200 dark:shadow-none"
          >
            Download Report
          </button>
        </div>
